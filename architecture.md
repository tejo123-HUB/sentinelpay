...
Seventeen features (1-14, 16, 17, 18, 19) are complete and merged with passing tests as of this table's last update. The remaining feature (15, the dashboard) is next — see Section 15.16's phasing for the build order.
